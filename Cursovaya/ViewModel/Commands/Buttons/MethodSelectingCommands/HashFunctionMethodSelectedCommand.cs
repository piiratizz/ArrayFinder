...
{
    internal class HashFunctionMethodSelectedCommand : CommandBase
    {
        private FindMethodCreator<int> _methodCreator;

        public HashFunctionMethodSelectedCommand()
        {
        ...
        {
            _methodCreator.SetMethodCreator(() => new HashFunctionMethod());
        }
    }
}
